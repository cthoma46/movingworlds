...
registerStepRepresentative = (req, res) ->
...
registerTwoRepresentative = (req, res) ->
  rep_id = req.user._id
  organization = new Organization()
...
registerThreeRepresentative = (req, res) ->
  rep_id = req.user._id
  Organization.findOne rep_id: rep_id, (err, org) ->
    unless err
...
module.exports = [
  ...
  ,
    ...
    type : 'GET'
    login : 'org'
    action : registerStepRepresentative
  ,
    path : '/register/2/representative'
    type : 'POST'
    login : 'org'
    action : registerTwoRepresentative
  ,
    path : '/register/3/representative'
    type : 'POST'
    login : 'org'
    action : registerThreeRepresentative
]
